...
exports.createNewAccessTokenWithRefreshToken = exports.createUsersToken = void 0;
...
const createNewAccessTokenWithRefreshToken = (refreshToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if ((isUserExist === null || isUserExist === void 0 ? void 0 : isUserExist.status) === user_interface_1.UserStatus.BLOCKED || (isUserExist === null || isUserExist === void 0 ? void 0 : isUserExist.status) === user_interface_1.UserStatus.INACTIVE) {
